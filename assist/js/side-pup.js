...
*******************/
    ...
    $("#toastr-success-top-right").on("click", function () {
        ...
        $("#toastr-info-top-right").on("click", function () {
                toastr.info("Sorry ! You can't add this account", "Warning!", {
                    positionClass: "toast-top-right",
                    timeOut: 5e3,
                    closeButton: !0,
                    debug: !1,
        ...
        $("#toastr-warning-top-right").on("click", function () {
                toastr.warning("This feature is not allowed in your country,", "Error!!", {
                    positionClass: "toast-top-right",
                    timeOut: 5e3,
                    closeButton: !0,
                    debug: !1,
        ...
        $("#toastr-danger-top-right").on("click", function () {
                toastr.error("You are currently unable to withdraw funds, please contact us", "Error !", {
                    positionClass: "toast-top-right",
                    timeOut: 5e3,
                    closeButton: !0,
                    debug: !1,
